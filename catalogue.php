      ...
      <div class="col col-12 col-lg-12 col-xl-10 col-xxl-8">
                ...
                <ul class="navbar-nav mx-auto">
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <ul id="services" class="dropdown-menu">
                      <li>
                        <a class="nav-link no-underline text-li-services" href="boschService.html">ATELIER BOSCH CAR SERVICE</a>
                      </li>
                      <li class="divider"></li>
                      <li>
                        <a class="nav-link no-underline text-li-services" href="carRegistration.html">SERVICE CARTE GRISE</a>
                      </li>
                      <li class="divider"></li>
                      <li>
                        <a class="nav-link no-underline text-li-services" href="infoConsumer.html">INFORMATIONS CONSOMMATEUR</a>
                      </li>
                    </ul>
                  </li>
        ...
        <div class="row">
          <div class="container catalogue text-center">
            <p class="my-auto">
              <a class="no-underline text-danger text-p" href="ourCars.html">Consultez notre catalogue jusqu'à 1500 véhicules
                disponibles</a>
            </p>
          </div>
        </div>
