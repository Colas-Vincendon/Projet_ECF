      ...
      <div class="col col-12 col-lg-12 col-xl-10 col-xxl-8">
        ...
        <div class="col-md-12 my-5">
          <h2 style="text-align: center">
            <img id="carteGrise" src="./src/medias/carteGrise.png" />
          </h2>

          <h2 class="my-5" style="text-align: center; font-size: 2rem">
            <strong>Un professionnel agréé moyennant</strong>
          </h2>

          <h2 style="text-align: center; font-size: 2rem">
            <span style="color: rgb(255, 0, 0)">une prestation de service de 50€ TTC pour le SIV<br /></span>
          </h2>
          <div class="certificate mx-auto">
            <p style="text-align: center">
              <br /><span style="
                    ...
                    font-size: 14px;
                  ">Agréé & Habilité </span><strong> Ministère de l'Intérieur</strong>
            </p>

            <p style="text-align: center">Agrément n°151587</p>
          </div>
        </div>
