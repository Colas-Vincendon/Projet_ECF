    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col col-12 col-lg-12 col-xl-10 col-xxl-8">
              ...
              <div class="container d-flex justify-content-start">
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                  <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                      <a class="nav-link nav-link-active" href="contact.php"
                        >CONTACT</a
                      >
                    </li>
                  </ul>
          ...
          <!-- ------------------------------ DEBUT MAIN ------------------------------- -->
          <section
            class="section section-no-background section-no-border m-none p-none"
          >
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <h4 class="panel-title">
                          <a
                            class="accordion-toggle no-underline text-red-bold ms-3"
                    ...
                    <div class="row">
                      <div class="form-group">
                        ...
                        <div class="col-md-12">
                          ...
                          <input
                            value=""
                            data-msg-required="Votre email"
                            data-msg-email="Adresse email non valide"
                            maxlength="100"
                            class="form-control"
                            name="email"
                            id="email"
                    ...
                    <div class="row my-4">
                      <div class="col-md-12">
                        <input
                          value="Envoyer"
                          name="envoimsg"
                          class="btn btn-form btn-lg mb-xlg"
