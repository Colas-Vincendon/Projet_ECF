            ...
            <div class="container d-flex justify-content-start">
              ...
              <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mx-auto">
                  ...
                  <li class="nav-item">
                    <a class="nav-link nav-link-active" href="contact.php">CONTACT</a>
                  </li>
                </ul>
              </div>
            </div>
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <h4 class="panel-title">
                        <a class="accordion-toggle no-underline text-red-bold ms-3" data-toggle="collapse"
                          href="#panel-cart-discount" aria-expanded="true">
                          Nous contacter
                        </a>
                      </h4>
                    </div>
                ...
                <form class="text-grey fs-6" id="contactForm" action="leaveMessage.php" method="POST">
                  <div class="row">
                    <div class="form-group">
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <label>Nom *</label>
                          <input value="" data-msg-required="Votre nom" maxlength="100" class="form-control" name="nom"
                          id="nom" required="required" aria-required="true" type="text" />
                        </div>
                        <div class="col-md-6">
                          <label>Prénom *</label>
                          <input value="" data-msg-required="Votre prénom" maxlength="100" class="form-control" name="prenom"
                          id="prenom" required="required" aria-required="true" type="text" />
                        </div>
                      </div>
                      <div class="col-md-12">
                        <label>Email *</label>
                        <input value="" data-msg-required="Votre email" data-msg-email="Adresse email non valide"
                  ...
                  <div class="row">
                    <div class="form-group">
                      <div class="col-md-12">
                        <label>Sujet</label>
                        <input value="" data-msg-required="Sujet" maxlength="100" class="form-control" name="sujet"
                          id="sujet" required="required" aria-required="true" type="text" />
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group">
                      <div class="col-md-12">
                        ...
                        <textarea maxlength="5000" data-msg-required="Please enter your message." rows="10"
                          class="form-control" name="message" id="message" required="required"
