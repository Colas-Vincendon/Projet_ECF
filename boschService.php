          ...
          <div class="row mb-xl">
            ...
            <div class="col-md-12 my-5">
              <p style="text-align: center">
                <span style="font-size: 28px" class="text-grey"><strong>Vous nous faites confiance pour l'achat de votre
                    véhicule,</strong></span>
              </p>

              <p style="text-align: center" class="text-grey">
                <span style="font-size: 28px"><strong>faites nous confiance pour son entretien.</strong></span>
              </p>

              <p style="text-align: center">
                <span class="text-grey"><span style="font-size: 20px"><strong>«&nbsp;L'efficacité ne dépend pas de la
                      taille de
                      l'entreprise, mais des Hommes qui la
                      composent&nbsp;»</strong></span></span>
              </p>
              ...
              <div class="text-grey" style="font-size: 1.2rem">
                ...
                <p style="text-align: center; font-size: 1.5rem" class="text-dark-grey-bold my-5">
