      ...
      <div class="row">
        ...
        <div class="col col-12 col-lg-12 col-xl-10 col-xxl-8">
              ...
              <div class="container d-flex justify-content-start">
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                  <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                      <a class="nav-link nav-link-active" href="cashback.php"
                        >RACHAT CASH</a
                      >
                    </li>
          ...
          <div class="container">
            <div class="row cols-2">
              <div class="col-12 col-md-5">
                <img
                  class="img-fluid"
                  src="./src/medias/carte_notre_concept.png"
                  alt=""
                />
              </div>
              ...
              <div class="col-12 col-md-4 d-flex justify-content-center">
                <div class="row">
                  <div class="col-12 d-flex justify-content-center">
                    <img
                      class="img-fluid logo-cachback"
                      src="./src/medias/icone_presdechezvous.png"
              ...
              <div class="col-12 col-md-4 d-flex justify-content-center">
                <div class="row">
                  <div class="col-12 d-flex justify-content-center">
                    <img
                      class="img-fluid logo-cachback"
                      src="./src/medias/icone_reprise.png"
                      alt="logo reprise"
                    />
                  </div>
                  <p class="text-center my-3">
                    Prix de reprise
                    <span class="text-red-bold"
                      >ferme, sans obligation d'achat</span
                    >
                  </p>
                </div>
              </div>
              <div class="col-12 col-md-4 d-flex justify-content-center">
                <div class="row">
                  <div class="col-12 d-flex justify-content-center">
                    <img
                      class="img-fluid logo-cachback"
                      src="./src/medias/icone_paiement.png"
                      alt="logo paiement"
                    />
                  </div>
                  <p class="text-center my-3">
          ...
          <div class="row text-center my-5">
            <a
              target="_blank"
              href="https://proxiautocash.com/"
              class="a_sans_surlignage"
              ><button
