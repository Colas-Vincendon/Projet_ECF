            ...
            <div class="col col-12 col-lg-12 col-xl-10 col-xxl-8">
                ...
                <div class="row">
                    <div class="container catalogue text-center">
                        <p class="my-auto">
                            <a class="no-underline text-danger text-p" href="catalogue.php">Consultez notre catalogue
                                jusqu'à 1500
                ...
                <div class="container-fluid">
                    <div class="filtres my-3 px-2 text-center">
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-12 col-md-6 col-lg-3 d-flex flex-column my-1">
                                <select id="boite_de_vitesse" name="boite_de_vitesse" style="width: 200px;"
                                    class="mx-auto">
                        ...
                        <div class="row justify-content-center my-3">
                            <button id="reinitialiserLesFiltres" class="btn btn-outline-danger">Réinitialiser les
                                filtres</button>
                        </div>
